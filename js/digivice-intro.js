/**
 * Digivice Boot Intro
 * Plays the PACT device reveal video before the main login cinematic.
 * Uses blob fetch to avoid dev server range-request issues with <video>.
 */
export const DigiviceIntro = {
  ...
  _createOverlay() {
    ...
    Object.assign(o.style, {
      ...
      alignItems:'center',justifyContent:'center',background:'#020204',
  ...
  _createVideo(src) {
    ...
    Object.assign(v.style, {
      maxHeight:'85vh',maxWidth:'90vw',borderRadius:'8px',objectFit:'contain',
      filter:'brightness(1.05) contrast(1.05)',opacity:'0',transform:'scale(0.95)',
    ...
    Object.assign(vi.style, {
      position:'absolute',inset:'0',pointerEvents:'none',borderRadius:'8px',
      background:'radial-gradient(ellipse at center,transparent 60%,rgba(2,2,4,0.6) 100%)',
    });
  ...
  _createSkipButton() {
    ...
    Object.assign(b.style, {
      position:'absolute',bottom:'32px',right:'32px',fontFamily:'monospace',
      fontSize:'9px',color:'#4b5563',letterSpacing:'0.15em',textTransform:'uppercase',
      cursor:'pointer',background:'none',border:'1px solid #1f2937',borderRadius:'4px',
      padding:'6px 12px',opacity:'0',transition:'opacity 0.5s, color 0.2s, border-color 0.2s',
    });
  ...
  _createWatermark() {
    ...
    Object.assign(m.style, {
      position:'absolute',top:'24px',left:'24px',fontFamily:'monospace',
      fontSize:'9px',letterSpacing:'0.4em',textTransform:'uppercase',
      color:'rgba(0,240,255,0.15)',opacity:'0',transition:'opacity 0.5s',
    });
  ...
  _finish(resolve) {
    ...
    setTimeout(() => {
      ...
      this._overlay = null; this._video = null; this._skipBtn = null;
      resolve();
    }, 800);
  },
};
