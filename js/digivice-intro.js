...
export const DigiviceIntro = {
    ...
    play() {
        return new Promise((resolve) => {
            if (sessionStorage.getItem('digivice-intro-seen')) {
                resolve();
                return;
            }
    ...
    _createVideo(src) {
        ...
        Object.assign(sc.style, {
            ...
            borderRadius: mobile ? '0' : '8px',
            background:
                'repeating-linear-gradient(0deg,transparent,transparent 3px,rgba(0,240,255,0.015) 3px,rgba(0,240,255,0.015) 6px)',
        });
        // Vignette
    ...
    _showVideo() {
        ...
        if (this._video) {
            ...
            this._video.style.transform = 'scale(1)';
        }
    },
    ...
    _hideTapPrompt() {
        if (this._tapPrompt) {
            this._tapPrompt.remove();
            this._tapPrompt = null;
        }
    },
    _createSkipButton() {
        ...
        b.addEventListener('mouseenter', () => {
            ...
            b.style.borderColor = 'rgba(0,240,255,0.3)';
        });
