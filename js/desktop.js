    ...
    openApplicationsShowcase() {
        const categories = [
            ...
            },
            {
                ...
                color: '#ff4444',
                apps: [
                    { name: 'LETSTRADE', desc: 'Real-time options scanner + dashboard \u2014 35+ API routes, AI copilot, auto-trader', status: 'private' },
                    ...
                    { name: 'POOLCAST', desc: 'AI underwriting platform for creator asset-backed securities', status: 'private' },
            ...
            },
            {
                ...
                color: '#aa00ff',
                apps: [
                    { name: 'PASSION_INTERACTIVE', desc: 'AR gesture/voice OS \u2014 hand tracking controls all projects and databases', status: 'private' },
                    ...
                    { name: 'PORTFOLIO_OS', desc: 'This cyberpunk desktop OS \u2014 46 vanilla JS modules, Three.js, zero frameworks', status: 'live', link: 'https://github.com/DareDev256/portfolio-os' },
                    { name: 'PRIVACY_SHIELD', desc: 'Defensive OSINT tool \u2014 find your digital footprint, remove from data brokers', status: 'private' },
                    { name: 'VEHICLE_TRACKER', desc: 'Dealership detailing hour tracker \u2014 Streamlit + SQLite/Supabase', status: 'private' },
                ],
            },
            {
                ...
                color: '#00ff88',
                apps: [
                    { name: 'VIBE_CODER', desc: 'Vampire survivors-style idle game powered by coding', status: 'private' },
                    ...
                    { name: 'TYPEMASTER', desc: 'Customizable typing game \u2014 fork and add your own curriculum', status: 'private' },
                    { name: 'RED_TEAM_ARENA', desc: 'Break the AI \u2014 learn prompt injection through ethical challenges', status: 'private' },
                    { name: 'NIN_WIKI', desc: 'AI-assisted Nin Online Wiki with approval workflows', status: 'private' },
                ],
            },
        ];
                ...
                <div class="portfolio-thumb-grid portfolio-thumb-grid--demos scroll-reveal" data-reveal="fade-up" data-reveal-delay="2">
                    ${DEMOS.map(d => {
                        const thumbMap = {
                            ...
                            'Cleaning — PRISTINE': '/thumbnails/demo-cleaning.jpg',
                            'Cleaning — BLANC': '/thumbnails/demo-cleaning-premium.jpg',
