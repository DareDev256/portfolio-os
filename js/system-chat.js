...
(function () {
    ...
    const ANSWERS = [
        ...
        },
        {
            ...
            a: [
                'An open-source MCP server for Final Cut Pro — 90 stars, on PyPI, about 1,900 installs a month. A sports-betting analytics product with real money moving through it. Eleven client sites live right now.',
