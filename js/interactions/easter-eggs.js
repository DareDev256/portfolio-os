...
export const EasterEggs = {
    ...
    handleKeyPress(e) {
        ...
        if (e.key >= '0' && e.key <= '9') {
            ...
            this.numBufferTimeout = setTimeout(() => {
                this.numBuffer = '';
            }, 2000);
    ...
    initSystemInfoShortcut() {
        document.addEventListener('keydown', (e) => {
            ...
            if (e.ctrlKey && e.shiftKey && e.key === 'V') {
                ...
                Notify.success(
                    `OS: Passion-OS v4.2.0 | Uptime: ${mins}m ${secs}s | Windows: ${windowCount} active | CPU: Vibes only`,
                    5000
                );
            }
        });
    ...
    getTerminalSass(command) {
        ...
        const responses = {
            ...
            history:
                '1. Googled "how to look like a hacker"\n2. Found this portfolio\n3. Opened terminal\n4. Typed "history"\n5. Got roasted\n...you are here.',
            fortune: [
            ...
            'ssh root@passion-os':
                "Connection established... just kidding. You're already inside. There is no outside.",
            'rm -rf node_modules':
                "Deleted 847,293 files. Just kidding — but wouldn't THAT be satisfying?",
            ...
            'apt-get install girlfriend':
                'E: Unable to locate package. Have you tried Stack Overflow?',
        };
