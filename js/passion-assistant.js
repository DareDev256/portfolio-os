...
const KNOWLEDGE = {
    ...
    clients: ['ShopBayHQ', 'Edson Legal', 'BetMetrics.ca', 'MustHaveFrenchies', 'SAVV4X', 'The Syren Effect'],
...
const RESPONSES = {
    greeting: () => pickRandom([
        ...
        `Welcome! I'm Passion. James has been busy — 12 client sites live, 20+ industry demos in the works. Looking for web design, branding, AI, or something else?`,
