...
const KNOWLEDGE = {
    services: {
        web: {
            ...
            price: '$250 – $2,000+',
            note: 'Custom-built, no templates, you own everything',
        },
        ecommerce: {
            name: 'E-Commerce & Online Stores',
            price: '$1,500 – $3,000',
            note: 'Full store setup with payments',
        },
        branding: {
            name: 'Branding & Visual Identity',
            price: '$300 – $800',
            note: 'Logo, colors, brand guide',
        },
        photo: {
            name: 'Photography & Videography',
            price: '$500 – $3,000',
            note: 'Music videos, product shoots, events',
        },
        ai: {
            name: 'AI & Automation',
            price: 'Custom quote',
            note: 'Chatbots, workflow automation, AI agents',
        },
        creative: {
            name: 'Creative Direction',
            price: '$200 – $1,000',
            note: 'Brand strategy, campaigns, content planning',
        },
    },
...
const INTENTS = [
    ...
    {
        id: 'passion',
        patterns: [/who.*passion|what.*passion|are you.*ai|are you.*bot|are you.*real/i],
    },
    { id: 'thanks', patterns: [/thank|thanks|thx|appreciate|awesome|perfect|great/i] },
    {
        id: 'industries',
        patterns: [/industry|categor|type.*business|restaurant|salon|barber|gym|dental/i],
    },
];
...
const RESPONSES = {
    ...
    services: () => {
        const list = Object.values(KNOWLEDGE.services)
    ...
    function showFollowUp(labels) {
        ...
        labels.forEach((label) => {
            ...
            btn.addEventListener('click', () => {
                row.remove();
                const action =
                    label.toLowerCase().includes('book') || label.toLowerCase().includes('quote')
                        ? 'booking'
