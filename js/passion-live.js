...
const VALID_STATES = new Set(['working', 'thinking', 'sleeping', 'focused', 'celebrating', 'idle']);
...
const FALLBACK = {
    ...
    lastActive: 'unknown',
    greeting:
        "Hey! I'm Passion, James's AI assistant. He's been busy — " +
        getRandomHighlight().toLowerCase() +
...
const TOUR_QUIPS = {
    welcome:
        "Welcome! I run 24/7 on a Mac Mini keeping James's code in check. Let me show you around.",
