...
![Version](https://img.shields.io/badge/v3.51.0-00f0ff?style=flat-square&labelColor=0d0d0d)
...
> `60 modules` · `30 stylesheets` · `444 tests / 23 suites` · `21 desktop apps` · `0 dependencies`
...
├── dom-helpers.js                  # Shared utilities (isPageHidden, prefersReducedMotion, isElementVisible, isInViewport, openExternal, animateCounter, loadJSON, saveJSON, downloadJSON, loadBool, saveBool)
